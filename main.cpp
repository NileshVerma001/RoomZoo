...
#include <bits/stdc++.h> // Header file for Standard Template Library (STL)
...
#include <direct.h>      // Directory manipulation header file
#include <iomanip>       // Input/output manipulator header file
#include <ctype.h>       // Character type header file
#include <cstdio>        // Standard input/output header file
#include <cstring>       // String manipulation header file
#include <cstdlib>       // Standard library header file
#include <stdlib.h>      // Standard library header file
#include <windows.h>     // Windows API header file
#include <wincon.h>      // Windows console API header file
...
void R_MODIFY()
{
    ...
    if (!ROOMFound)
    {
        cout << "\nROOM with ROOM Number " << roomNumber << " not found.";
    }
...
void R_MODIFY_FORAVL(int roomNumber)
{
    ofstream fout("rtype.tmp", ios::out | ios::binary);
    ifstream fin("ROOMtype.txt", ios::in | ios::binary);
    if (!fin)
    ...
    else
    {
        ...
        while (fin.read((char *)&c, sizeof(c)))
        {
            if (roomNumber == c.ROOM)
            {
                ...
                cout << "\n***********************";
                cout << "\nENTER ROOM ID TO MODIFY: " << roomNumber;
                cout << "\nNAME: ";
                cin >> c1.name;
                fflush(stdin);
...
int thankYouMessage()
{
    ...
    cout << "\\__    __/ |  |_   _____      ____   |  | __    \\__  |   |   ____    __ __      \n";
    cout << "  |    |    |  |  \\  \\__  \\    /    \\  |  |/ /     /   |   |  /  _ \\  |  |  \\      \n";
    cout << "  |    |    |   Y  \\  / __ \\_ |   |  \\ |    <      \\____   | (  <_> ) |  |  /         \n";
    cout << "  |___|    |___|  / (___  / |__|  / |__| \\     / ______|  \\____/  |____/ \n";
    cout << "                 \\/       \\/       \\/       \\/     \\/                        \n";
